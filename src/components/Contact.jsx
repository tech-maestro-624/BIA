            ...
            <div className="bg-gray-50 rounded-3xl p-8 lg:p-10">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <button
                  ...
                  className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-4 rounded-full font-bold text-sm lg:text-base flex items-center justify-center gap-2 transition-all duration-300 hover:-translate-y-1 shadow-lg"
